...
public class RPSLSpock {
    ...
    /**
     * @param pick user inputs rock, paper, scissors, lizard, and spock
     * @return false if user enters something other than rock, paper, scissors, lizard, and spock
     * true if user enters rock, paper, scissors, lizard, and spock correctly
     */
    ...
    /**
     * @return random computer pick 0f rock, paper, scissors, lizard, spock
     */
    ...
    /**
     * @param c_pick computer picks randomly
     * @param h_pick human or user picks
     * @return will be true if c_pick beats h_pick and false if h_pick beats c_pick
     */
